...
<head> 
    ...
    <title>Formulário para Atualizar Produto</title>
...
<?php
    ...
    $idProduto = $_GET['idCategoria'];

    $comando = "SELECT * FROM produto WHERE idCategoria = $idProduto";
...
?>
    <h2> Atualizar Produto </h2>
        ...
        <form method="POST" action="processa_atualizar_produto.php">
            <input type="hidden" name="idCategoria" value="<?=$idProduto?>">    
            Nome do produto: <input type="text" name="txtnome" value="<?=$linha['nomeProduto']?>"><br>
            Preço: <input type="text" name="txtpreco" value="<?=$linha['preco']?>"><br>
            Descrição: <input type="text" name="txtdescricao" value="<?=$linha['descricao']?>"><br>

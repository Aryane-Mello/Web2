...
<?php
    ...
    $estminimo = $_POST['txtestoqueminimo'];
    $estmaximo = $_POST['txtestoquemaximo'];
    $qntestoque = $_POST['txtqntestoque'];
    
    
    $comando = "INSERT INTO produto (idProduto, idCategoria, preco, nomeProduto, descricao, estoque_minimo, estoque_maximo, quant_estoque)
    VALUES ('$produto', '$categoria', '$preco', '$nome', '$descricao', '$estminimo', '$estmaximo', '$qntestoque')";

    $result = mysqli_query($conexao, $comando);
   
    if ($result){
        require "cabecalho.php";
        echo "O novo produto foi inserido com sucesso!";
    }
    else{

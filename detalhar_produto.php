...
<div id="Cabeçalho">
    ...
    ?>      
                <p> Produto: <?=$linha['idProduto']?> </p>
                <p> Categoria: <?=$linha['idCategoria']?> </p>
                <p> Preço: <?=$linha['preco']?> </p>
                <p> Nome: <?=$linha['nomeProduto']?> </p>
                <p> Descrição: <?=$linha['descricao']?> </p>
                <p> Estoque Mínimo: <?=$linha['estoque_minimo']?> </p>
                <p> Estoque Maximo: <?=$linha['estoque_maximo']?> </p>
                <p> Quantidade no Estoque: <?=$linha['quant_estoque']?> </p>
    <?php
        }
    ?>
    <br>

...
<html>
    ...
    <a href="login.php"> Cadastrar Usuario </a>
    <?php
        ...
        ?>    
                ...
                <a href = "detalhar_usuario.php?cpf=<?=$linha['cpf']?>"> Ver Usuario </a><br>
                <a href = "formulario_atualizar_usuario.php?cpf=<?=$linha['cpf']?>"> Alterar Usuario </a><br>
                <a href = "deletar_usuario.php?cpf=<?=$linha['cpf']?>"> Excluir Usuario </a>

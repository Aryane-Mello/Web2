...
<div id="Cabeçalho">
    ...
    <a href="formulario_produto.php"> Cadastrar produto </a>
    <?php
    ...
    ?>    
                ...
                <h3> Nome: <?=$linha['nomeProduto']?></h3>
                <a href = "detalhar_produto.php?idCategoria=<?=$linha['idCategoria']?>"> Ver Produto </a><br>
                <a href = "formulario_atualizar_produto.php?idCategoria=<?=$linha['idCategoria']?>"> Alterar Produto </a><br>
                <a href = "deletar_produto.php?idCategoria=<?=$linha['idCategoria']?>"> Excluir Produto </a>

...
<?php
    ...
    $comando = "INSERT INTO endereco (idEndereco, cpf, logradouro, numero, complemento, bairro, cidade, cep)
    VALUES ('$endereco', '$cpf', '$logradouro', '$numero', '$complemento', '$bairro', '$cidade', '$cep')";
